...
// Convert a promise generated with another promise module to a 'deferred' promise

function shimPromise(promise) {
  var def = deferred();
...
module.exports = function (connect) {
  ...
  function RethinkStore(options) {
    ...
    this.clientPromise = options.clientPromise ? shimPromise(options.clientPromise) : promisify(r.connect)(options.clientOptions);
    var self = this;
